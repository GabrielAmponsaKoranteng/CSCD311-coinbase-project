                ...
                <div className="container">
                    ...
                    <div className="nav-collapse" id="application_menu">
                        ...
                        <ul className="nav clearfix">
                            ...
                            <li className="active signin"><a href="#">Sign In</a></li>
                            <li style={{marginTop:'-1px'}} className=" signup"><a href="#" className="btn">Sign Up</a></li>
                        </ul>
                    </div>
                </div>
            </div>
